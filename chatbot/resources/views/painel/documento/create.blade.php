<x-dashboard title="Cadastro de conhecimentos">

    <div class="pt-5 text-center">
        <h2>Cadastro de conhecimentos</h2>
    </div>
        ...
        <div class="col-9">
            ...
            <form action="{{route('documento.store')}}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="titulo" aria-describedby="titulo" name="titulo" placeholder="Informe o título do que se refere o conhecimento">
                </div>
                <div class="mb-3">
                    <label for="name" class="form-label">Conhecimento</label>
                    <input type="text" class="form-control" id="conteudo" aria-describedby="conteudo" name="conteudo" placeholder="Exemplo: Serviços da clínica, Sobre a empresa ou Atendimento ao cliente">
                </div>
                <div class="mb-3">
                    <label for="bot" class="form-label">Bot</label>
                    <select class="form-select" aria-label="Default select example" id="bot" name="bot">
                        @foreach ($bots as $bot)
                            <option value="{{$bot->id}}">{{$bot->nome}}</option>
                        @endforeach
                    </select>
                </div>
